...
use app\modules\asm\models\ModulesSearch;
use Yii;
...
class ModulesController extends Controller
{
        ...
        if ($request->isAjax) {
            ...
            */
            ...
            if ($request->isGet) {
                ...
                $model->code = md5($model->name . uniqid());
                $model->save();

                return [
                    'forceReload' => '#crud-datatable-pjax',
                    'title' => "Create new Modules",
                    'content' => '<span class="text-success">Create Modules success</span>',
                    'footer' => Html::button('Close', ['class' => 'btn btn-default pull-left', 'data-dismiss' => "modal"]) .
    ...
    /**
     * Delete an existing Modules model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
        ...
        if($this->findModel($id)->delete()){
            ModulesAction::deleteAll(['module'=>$id]);
            ModulePermission::deleteAll(['module'=>$id]);
        }
