    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'header'=>'Cost',
                'value'=>function($data){
                    return !empty($data->cost_price)?Utility::asDecimal($data->cost_price):'';
                }
            ],
            [
                ...
                'header'=>'Wholesale',
                'value'=>function($data){
                    return !empty($data->wholesale_price)?Utility::asDecimal($data->wholesale_price):'';
                }
            ],
            [
                ...
                'header'=>'Retail',
                'value'=>function($data){
                    return !empty($data->retail_price)?Utility::asDecimal($data->retail_price):'';
                }
            ],
