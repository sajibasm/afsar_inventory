...
$date = $dateTime->setTimestamp(strtotime($data['date']))->setTimezone(new DateTimeZone(SystemSettings::getTimeZone()))->format(SystemSettings::dateTimeFormat());
...
<div class="cash-book-form">
    ...
    <div id="w1-container" class="table-responsive kv-grid-container" style="overflow: auto"
         data-resizable-columns-id="kv-3-fasf-w1">
        <table class="kv-grid-table table table-hover table-bordered table-striped table-condensed kv-table-wrap">
            <thead>
            <tr>
                <th style="width: 100%;" class="text-center warning" colspan="3">BANK SUMMERY (<?= $outlet->name ?>)
                </th>
            </tr>

            <tr class="kartik-sheet-style">
                <th style="width: 18.82%;" class="kv-align-center" data-resizable-column-id="kv-col-1" data-col-seq="1">
                    SOURCE(HEAD)
                </th>
                <th style="width: 18.82%;" class="kv-align-center" data-resizable-column-id="kv-col-1" data-col-seq="1">
                    DATE
                </th>
                <th style="width: 18.82%;" class="kv-align-right" data-resizable-column-id="kv-col-1" data-col-seq="1">
                    AMOUNT
                </th>
            </thead>
            <tbody>
            ...
            <tr>
                <td class="kv-align-right kv-align-middle" colspan="2" align="right" data-col-seq="11"><strong>Total
                        Inflow</strong></td>
                <td class="kv-align-right" data-col-seq="14"><strong><?= $data['totalDepositIn'] ?></strong></td>
            </tr>
            ...
            <tr>
                <td class="kv-align-right kv-align-middle" colspan="2" align="right" data-col-seq="11"><strong>Total
                        Outflow</strong></td>
                <td class="kv-align-right" data-col-seq="14"><strong><?= $data['totalDepositOut'] ?></strong></td>
            </tr>
